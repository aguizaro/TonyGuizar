        ...
        <div className="futplanner-content">
          ...
          <div className="jumbotron" id="futplanner-jumbotron">
            <p className="futplanner-text">
              I love watching and participating in sports, especially football.
              I often find myself missing many of the live events and matches
            ...
            <p className="futplanner-text">
              ...
              web interface for them to engage with and also for me to gain some
            ...
            <p className="futplanner-text">
              ...
              for an OAuth2 Google Calendar client. This API adheres to RESTful
              ...
              any feedback that may help me learn and improve the work that I
              do.
            </p>
            <p className="futplanner-text">
              My{" "}
              ...
              accepts GET requests for an unspecified number of league and team
              id pairs. These id pairs are used to retrieve data from{" "}
              <a
              ...
              Google Calendar. This link can be used to embed the calendar in
              any webpage, as well as be used to import the public calendar to
              any personal Google account.
            </p>
            <p className="futplanner-text">
